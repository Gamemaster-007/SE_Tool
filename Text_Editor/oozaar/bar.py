...
from oozaar import _findwm,Font,filect,_info
import os
try:
...
class menu:
    ...
    def __init__(self, root=None, text_bx=None,shortcut_bar=None, linebar=None,cursurbar=None):
        ...
        self.root.m_menu.add_command(label='New Window', accelerator='Ctrl+W', compound='left', underline=0, command=self.new_file)
        self.root.m_menu.add_separator()
